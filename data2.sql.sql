...
CREATE TABLE `demande_medicament` (
  ...
  `nom_medicament` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `photo_ordonance` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quartier_id` int DEFAULT NULL,
  `status_demande` enum('en_attente','trouver','nom_trouver','anullee') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pharmacies` (
  ...
  `nom_pharmacy` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quartier_id` int DEFAULT NULL,
  `latitude` decimal(10,8) DEFAULT NULL,
  `longitude` decimal(11,8) DEFAULT NULL,
  `est_garde` tinyint(1) DEFAULT NULL,
  `est_ouvert` tinyint(1) DEFAULT NULL,
  `photo_license` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `quartiers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nom_quartiers` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `utilisateure` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telephone` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mots_de_passe` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rol` enum('patient','pharmacy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'patient',
  PRIMARY KEY (`id`)
...
--
-- Dumping routines for database 'chiva'
--
...
-- Dump completed on 2026-04-02 18:24:46
